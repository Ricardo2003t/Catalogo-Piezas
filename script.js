...
const productos = [
  ...
  { marca:'peugeot', nombre:'Junta Block Metal', modelo:['dw8','xud9'], tipo:'repuesto', precio:35.00, precioOriginal:null, imagenes:['Piezas/Peugeot/Junta de Block Metal DVV8 XUD9.webp'], descripcion:'Junta de block metal para motores DW8 y XUD9. Altamente resistente a presiones y temperaturas.', oferta:false, disponible:true },
  ...
  { marca:'peugeot', nombre:'Kit de Retenes', modelo:['Peugeot'], tipo:'repuesto', precio:35.00, precioOriginal:null, imagenes:['Piezas/Peugeot/Kit de Retenes (peugeot).webp'], descripcion:'Kit completo de retenes para motores Peugeot. Evita fugas de aceite y protege los componentes internos.', oferta:false, disponible:true },
  ...
  { marca:'peugeot', nombre:'Líquido Freno 1L', modelo:['Mannol'], tipo:'aceite', precio:10.00, precioOriginal:null, imagenes:['Piezas/Peugeot/Liquido Freno (1 litro).webp'], descripcion:'Líquido de freno de 1 litro, especificación DOT 4. Alta resistencia térmica para frenado seguro.', oferta:false, disponible:true },
  ...
  { marca:'peugeot', nombre:'Metales Biela y Bancada', modelo:['xud9turbo','tu5jp4'], tipo:'repuesto', precio:90.00, precioOriginal:null, imagenes:['Piezas/Peugeot/Metales de Biela y Bancada TUD5 XUD9 XUD9turbo DVV8 TU5JP4(301).webp'], descripcion:'Metales de biela y bancada específicos para motores XUD9 Turbo y TU5JP4 (301).', oferta:false, disponible:true },
  ...
  { marca:'peugeot', nombre:'Kit Pistones Aros Pasador', modelo:['tud5'], tipo:'repuesto', precio:290.00, precioOriginal:null, imagenes:['Piezas/Peugeot/Piston Aros Pasador TUD5.webp'], descripcion:'Kit completo de pistones, aros y pasadores de alta precisión para reconstrucción de motor.', oferta:false, disponible:true },
  { marca:'peugeot', nombre:'Kit Pistones Aros Pasador', modelo:['xud9','xud7','dw8'], tipo:'repuesto', precio:290.00, precioOriginal:null, imagenes:['Piezas/Peugeot/Kit Pistones Aros Pasador XUD9 XUD7 DW8.webp'], descripcion:'Kit completo de pistones, aros y pasadores de alta precisión para reconstrucción de motor.', oferta:false, disponible:true },
  { marca:'peugeot', nombre:'Pulmón Presión Aceite', modelo:['Peugeot'], tipo:'repuesto', precio:15.00, precioOriginal:null, imagenes:['Piezas/Peugeot/Pulmon Pesion Aceite (peugeot).webp'], descripcion:'Sensor de presión de aceite para motores Peugeot. Monitoreo preciso del sistema de lubricación.', oferta:false, disponible:true },
  ...
  { marca:'peugeot', nombre:'Radiador 106', modelo:['106'], tipo:'repuesto', precio:100.00, precioOriginal:null, imagenes:['Piezas/Peugeot/Radiador 106 .webp'], descripcion:'Radiador refrigerante para motor Peugeot 106. Máxima eficiencia de enfriamiento térmico.', oferta:false, disponible:true },
  ...
  { marca:'peugeot', nombre:'Aros de Pistón', modelo:['tud5','xud9','dw8'], tipo:'repuesto', precio:80.00, precioOriginal:85.00, imagenes:['Piezas/Peugeot/Aros de Piston  TUD5 XUD9 XUD9Turbo DVV8 TU5JP4(301).webp'], descripcion:'Aros de pistón de alta calidad. Garantizan sellado perfecto y máxima compresión.', oferta:true, disponible:true },
  ...
  { marca:'peugeot', nombre:'Kit Juntas XUD9', modelo:['xud9'], tipo:'repuesto', precio:105.00, precioOriginal:null, imagenes:['Piezas/Peugeot/kit junta xud9 .webp'], descripcion:'Kit completo de empaquetaduras para motor XUD9. Calidad superior OEM.', oferta:false, disponible:true },
  ...
  { marca:'peugeot', nombre:'Correa 5PK775', modelo:['Peugeot'], tipo:'correa', precio:20.00, precioOriginal:null, imagenes:['Piezas/Peugeot/Correa 5PK775.webp'], descripcion:'Correa poli-V 5PK775 de alta calidad. Compatible con varios modelos Peugeot y universal. Resistente al calor y desgaste.', oferta:false, disponible:true },
  ...
  { marca:'peugeot', nombre:'Rodamiento Delantero Universal', modelo:['Peugeot'], tipo:'repuesto', precio:50.00, precioOriginal:null, imagenes:['Piezas/Peugeot/Rodamiento Delantero Universal CITROEN.webp'], descripcion:'Rodamiento de rueda frontal universal para Peugeot y Citroën. Precisión de giro superior.', oferta:false, disponible:true },
